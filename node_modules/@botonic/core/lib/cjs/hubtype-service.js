...
class HubtypeService {
    ...
    _initPusher() {
        ...
        this.pusher = new pusher_js_1.default(WEBCHAT_PUSHER_KEY, Object.assign({ cluster: 'eu', authEndpoint: `${HUBTYPE_API_URL}/v1/provider_accounts/webhooks/webchat/${this.appId}/auth/`, forceTLS: true, auth: {
    ...
    postMessage(user, message) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield axios_1.default.post(`${HUBTYPE_API_URL}/v1/provider_accounts/webhooks/webchat/${this.appId}/`, {
                    sender: this.user,
                    message: message,
                }, {
    ...
    static getWebchatVisibility({ appId, }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return axios_1.default.get(`${HUBTYPE_API_URL}/v1/provider_accounts/${appId}/visibility/`);
        });
    }
    destroyPusher() {
        if (!this.pusher)
