...
function getOpenQueues(session, context = {}) {
 ...
 */
function humanHandOff(session, queueNameOrId = '', onFinish) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function _humanHandOff(session, queueNameOrId = '', onFinish, agentEmail = '', agentId = '', forceAssignIfNotAvailable = true, autoAssignOnWaiting = false, caseInfo = '', note = '', autoIdleMessage = '', shadowing = false, extraData = undefined) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const params = {};
...
function storeCaseRating(session, rating, context = {}) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const baseUrl = session._hubtype_api || HUBTYPE_API_URL;
...
function getAvailableAgentsByQueue(session, queueId) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const baseUrl = session._hubtype_api || HUBTYPE_API_URL;
        const resp = yield (0, axios_1.default)({
            headers: {
...
function getAvailableAgents(session) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const baseUrl = session._hubtype_api || HUBTYPE_API_URL;
...
function getAgentVacationRanges(session, { agentId, agentEmail }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const baseUrl = session._hubtype_api || HUBTYPE_API_URL;
        const botId = session.bot.id;
        const resp = yield (0, axios_1.default)({
