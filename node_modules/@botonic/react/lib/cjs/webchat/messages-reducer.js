...
const messagesReducer = (state, action) => {
    switch (action.type) {
        case actions_1.WebchatAction.ADD_MESSAGE:
            return addMessageReducer(state, action);
        case actions_1.WebchatAction.ADD_MESSAGE_COMPONENT:
            return addMessageComponent(state, action);
        case actions_1.WebchatAction.UPDATE_MESSAGE:
            return updateMessageReducer(state, action);
        case actions_1.WebchatAction.UPDATE_REPLIES:
            return Object.assign(Object.assign({}, state), { replies: action.payload });
        case actions_1.WebchatAction.CLEAR_MESSAGES:
            return Object.assign(Object.assign({}, state), { messagesJSON: [], messagesComponents: [], numUnreadMessages: 0 });
        case actions_1.WebchatAction.UPDATE_LAST_MESSAGE_DATE:
            return Object.assign(Object.assign({}, state), { lastMessageUpdate: action.payload });
        case actions_1.WebchatAction.RESET_UNREAD_MESSAGES:
            return resetUnreadMessages(state);
        case actions_1.WebchatAction.SET_LAST_MESSAGE_VISIBLE:
...
function addMessageComponent(state, action) {
    ...
    const isUnreadMessage = ((_a = messageComponent.props) === null || _a === void 0 ? void 0 : _a.isUnread) &&
        ((_b = messageComponent.props) === null || _b === void 0 ? void 0 : _b.sentBy) !== index_types_1.SENDERS.user;
